...
class GameManager extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae) //게임 시작 이벤트
	{
		if (playing == false)
		{
			level = 0;
	...
	public void actionPerformed1(ActionEvent e) // 일시정지 이벤트
	{
...
class RightPan extends JPanel
{
	...
	RightPan(GameManager gm)
	{
		...
		this.gm = gm;
		startBtn = new JButton("게임시작"); // 게임시작버튼
		startBtn.addActionListener(gm);
		stopStartBtn = new JButton("일시정지"); //일시정지버튼
